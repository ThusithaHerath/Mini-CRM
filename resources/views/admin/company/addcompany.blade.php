...
<header>
  ...
  <main class="main-body" style="margin-top: 58px; margin-left: 70px;  ">
    <form action="{{url('store-company')}}" method="POST" enctype="multipart/form-data" style="padding-top: 30px;">
        {{ csrf_field() }}
        ...
        <div class="form-group">
            ...
            <input type="text" name="website" class="form-control" id="exampleInputPassword1" placeholder="Website" required>
          </div>
        ...
        <a href="{{url('manage-companies')}}" class="btn btn-danger">Cancel</a>
      </form>
  </main>
  <!--Main layout-->
  <style>
