  ...
  <main class="main-body" style="margin-top: 58px; margin-left: 70px;  ">
    <form action="{{url('update-employee/'.$employee->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" name="fname" class="form-control" value="{{$employee->firstname}}"  required>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Last Name</label>
            <input type="text" name="lname" class="form-control" value="{{$employee->lastname}}"  required>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Company</label>
            <select name="company" class="form-control">
                <option selected value="{{$employee->company_id}}">{{$employee->company ? $employee->company->name: ''}}</option>
        ...
        <div class="form-group">
            ...
            <input type="number" name="phone" class="form-control" id="exampleInputPassword1"  value="{{$employee->phone}}" maxlength="10"  >
          </div>
