...
<header>
  ...
  <main class="main-body" style="margin-top: 58px; margin-left: 70px;">
    ...
    <div class="alert alert-primary alert-dismissible fade show" role="alert">
        <strong>Success!</strong> {{session('employee_added')}}
    </div>
    @endif
    ...
    <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong>Success!</strong> {{session('deleted_employee')}}
    </div>
    @endif
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>Success!</strong> {{session('employee_updated')}}
    </div>
    @endif
      ...
      <tbody>
        @foreach ($employee as $item)
            <tr>
              ...
              <td>{{$item->phone}}</td>
              <td>
                <a class="btn btn-success"   href="{{url('edit-employee/'.$item->id)}}"><i class="far fa-edit"></i></a> &nbsp;
                <a class="btn btn-danger" href="{{url('remove-employee/'.$item->id)}}"><i class="fa fa-trash"></i></a>
              </td>
            </tr>
        @endforeach
      </tbody>     
